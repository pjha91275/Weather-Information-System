        ...
        <body>
            ...
            <div class="container text-center">
                        ...
                        <div class="glass card-hover">
                            ...
                            <c:if test="${not empty error}">
                                <div class="alert alert-warning mt-2 mb-3"
                                    style="font-size: 15px; border-radius: 10px; font-weight: bold;">
                                    ⚠️ ${error}
                                </div>
                            </c:if>
                            ...
                            <form action="WeatherServlet" method="post">
                                ...
                                <div style="position:relative">
                                    ...
                                    <input id="location" type="text" name="location"
                                        class="form-control form-control-lg" style="font-size: 1.5rem; padding: 15px;"
                                        placeholder="Enter city" onkeyup="suggestCities()" required>
                                ...
                                <button class="btn btn-primary w-100 mt-3 btn-lg"
                                    style="font-size: 1.4rem; padding: 12px;">Get Weather</button>
                ...
                <div class="text-center mt-4">
                    ...
                    <a href="WeatherServlet" class="btn btn-light btn-lg"
                        style="font-size: 1.3rem; padding: 12px 30px;">View History</a>
