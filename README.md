...
- 🗂️ **Persistent History:** Search history stored in MySQL database.
...
- ⚠️ Severe weather alerts (Email/SMS)
- 🗺️ Interactive maps for weather tracking
